...
namespace SequentialSample
{
    ...
    [AppName("Sample/SequentialSample")]
    [AppDescription("Create2を前進、左旋回、前進させて終了するサンプル。")]
    [TargetRobot(RobotKind.Create2)]
    public class SequentialSample : GameApp
    {
        // コンストラクタ
        public SequentialSample(KobutanSystem kobutanSystem, RobotController robotController)
